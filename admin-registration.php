                    ...
                    <div class="card-body p-5 text-center"><a href="index.php"><i class="fa fa-home" style="color: white;font-size: 30px;" aria-hidden="true"></i></a>
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <div class="form-outline form-white mb-3">
                                <input type="number" id="typeEmail" class="form-control form-control-lg" placeholder="Admin ID" name="admin_id">
                            </div>
                            <div class="form-outline form-white mb-3">
                                <input type="text" id="typeEmail" class="form-control form-control-lg" placeholder="First Name" name="first_name">
                            </div>
                            <div class="form-outline form-white mb-3">
                                <input type="text" id="typeEmail" class="form-control form-control-lg" placeholder="Last Name" name="lname">
                            </div>
                            <div class="form-outline form-white mb-3">
                        ...
                        <div>
                            <p class="mb-0">Account already exist?<a href="admin-login.php" class="text-white-50 fw-bold">Login</a></p>
                        </div>
